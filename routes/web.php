...
// Route::get('/messages', [MessageController::class, 'developerlook_index'])->name('messages.index');
// Route::get('/messages/{user}', [MessageController::class, 'developerlook_show'])->name('messages.show');
// Route::post('/messages', [MessageController::class, 'developerlook_store'])->name('messages.store');
